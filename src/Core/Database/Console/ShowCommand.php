...
use LARAVEL\DatabaseCore\Schema\Builder;
...
class ShowCommand extends DatabaseInspectionCommand
{
     ...
     *
     * @param  \LARAVEL\DatabaseCore\ConnectionResolverInterface  $connections
     * @return int
     */
     ...
     * @param  \LARAVEL\DatabaseCore\Schema\Builder  $schema
