...
use LARAVEL\DatabaseCore\ConnectionResolverInterface;
use LARAVEL\DatabaseCore\Events\DatabaseBusy;
...
class MonitorCommand extends DatabaseInspectionCommand
{
     ...
     *
     * @param  \LARAVEL\DatabaseCore\ConnectionResolverInterface  $connection
