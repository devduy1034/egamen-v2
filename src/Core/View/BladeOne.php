...
class BladeOne
{
    ...
    protected string $echoFormat = '\html_entity_decode(%s??\'\', ENT_QUOTES, \'UTF-8\')';
    /** @var string */
    ...
    {
        clock()->event('View: '. $view)->color('blue')->begin();
    ...
    {
        return $this->canonicalUrl ?? $this->getCurrentPageURL_CANO();
    }

    public function getAmphtmlUrl(): ?string
    {
        
        return $this->getCurrentPageURL_AMP();
    }
    ...
    public function getCurrentPageURL_AMP() { //Hàm thêm mới - để thêm mới /amp/ vào đường link trong đường link hiện tại
		$pageURL = 'http';
     ...
     * @param $expression
     * @return string
     * @see BladeOne::getAmphtmlUrl
     */
    public function compileAmphtml($expression = null): string
    {
        return '<link rel="canonical" href="' . $this->phpTag
            . ' echo $this->getAmphtmlUrl();?>" />';
    }
