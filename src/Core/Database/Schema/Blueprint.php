...
use Closure;
use LARAVEL\DatabaseCore\Connection;
use LARAVEL\DatabaseCore\Eloquent\Concerns\HasUlids;
use LARAVEL\DatabaseCore\Query\Expression;
use LARAVEL\DatabaseCore\Schema\Grammars\Grammar;
use LARAVEL\DatabaseCore\Schema\Grammars\MySqlGrammar;
...
class Blueprint
{
     ...
     *
     * @var \LARAVEL\DatabaseCore\Schema\ColumnDefinition[]
     */
    protected $columns = [];
     ...
     * @return \LARAVEL\DatabaseCore\Schema\IndexDefinition
     */
     ...
     * @param  string|array  $columns
     * @param  string|null  $name
     * @return \LARAVEL\DatabaseCore\Schema\ForeignKeyDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \LARAVEL\DatabaseCore\Schema\ColumnDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \LARAVEL\DatabaseCore\Schema\ForeignIdColumnDefinition
     */
     ...
     *
     * @param  \LARAVEL\DatabaseCore\Schema\ColumnDefinition  $definition
     * @return \LARAVEL\DatabaseCore\Schema\ColumnDefinition
     */
