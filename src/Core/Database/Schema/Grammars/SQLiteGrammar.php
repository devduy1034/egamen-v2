<?php
namespace LARAVEL\DatabaseCore\Schema\Grammars;

use LARAVEL\DatabaseCore\Connection;
use LARAVEL\DatabaseCore\Query\Expression;
use LARAVEL\DatabaseCore\Schema\Blueprint;
use LARAVEL\DatabaseCore\Schema\ColumnDefinition;
use LARAVEL\DatabaseCore\Schema\ForeignKeyDefinition;
use LARAVEL\DatabaseCore\Schema\IndexDefinition;
...
class SQLiteGrammar extends Grammar
{
     ...
     *
     * @param  \LARAVEL\DatabaseCore\Schema\Blueprint  $blueprint
     ...
     *
     * @param  \LARAVEL\DatabaseCore\Schema\ForeignKeyDefinition[]  $foreignKeys
     * @return string|null
     */
