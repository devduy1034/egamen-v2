...
use LARAVEL\DatabaseCore\Concerns\BuildsQueries;
use LARAVEL\DatabaseCore\Concerns\ExplainsQueries;
use LARAVEL\DatabaseCore\ConnectionInterface;
use LARAVEL\DatabaseCore\Eloquent\Builder as EloquentBuilder;
use LARAVEL\DatabaseCore\Eloquent\Relations\Relation;
use LARAVEL\DatabaseCore\Query\Grammars\Grammar;
use LARAVEL\DatabaseCore\Query\Processors\Processor;
...
class Builder implements BuilderContract
{
     ...
     *
     * @var \LARAVEL\DatabaseCore\ConnectionInterface
     */
    public $connection;
     ...
     *
     * @var \LARAVEL\DatabaseCore\Query\Grammars\Grammar
     */
    public $grammar;
     ...
     *
     * @var \LARAVEL\DatabaseCore\Query\Processors\Processor
     */
    public $processor;
     ...
     *
     * @var \LARAVEL\DatabaseCore\Query\Expression|string
     */
    public $from;
     ...
     *
     * @var \LARAVEL\DatabaseCore\Query\IndexHint
     */
    public $indexHint;
     ...
     * @param  \LARAVEL\DatabaseCore\Query\Grammars\Grammar|null  $grammar
     * @param  \LARAVEL\DatabaseCore\Query\Processors\Processor|null  $processor
     * @return void
     */
     ...
     *
     * @param  \Closure|\LARAVEL\DatabaseCore\Query\Builder|\LARAVEL\DatabaseCore\Eloquent\Builder|string  $query
     * @param  string  $as
     * @return $this
     *
     ...
     *
     * @param  \Closure|\LARAVEL\DatabaseCore\Query\Builder|\LARAVEL\DatabaseCore\Eloquent\Builder|string  $table
     ...
     *
     * @param  \LARAVEL\DatabaseCore\Query\Builder  $parentQuery
     * @param  string  $type
     * @param  string  $table
     * @return \LARAVEL\DatabaseCore\Query\JoinClause
     */
     ...
     * @param  string  $type
     * @param  string  $table
     * @return \LARAVEL\DatabaseCore\Query\JoinLateralClause
     */
     ...
     *
     * @return \LARAVEL\DatabaseCore\Query\Builder
     */
     ...
     * @param  \Illuminate\Contracts\Database\Query\Expression|string  $column
     * @param  string  $operator
     * @param  \Closure||\LARAVEL\DatabaseCore\Query\Builder|\LARAVEL\DatabaseCore\Eloquent\Builder  $callback
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  \Closure|\LARAVEL\DatabaseCore\Query\Builder|\LARAVEL\DatabaseCore\Eloquent\Builder|\Illuminate\Contracts\Database\Query\Expression|string  $column
     ...
     *
     * @param  \Closure|\LARAVEL\DatabaseCore\Query\Builder|\Illuminate\Contracts\Database\Query\Expression|string  $column
     * @return $this
     */
     ...
     *
     * @param  \Closure|\LARAVEL\DatabaseCore\Query\Builder|\Illuminate\Contracts\Database\Query\Expression|string|null  $column
     * @param  string  $direction
     * @return $this
     */
     ...
     *
     * @param  \Closure|\LARAVEL\DatabaseCore\Query\Builder|\LARAVEL\DatabaseCore\Eloquent\Builder  $query
     * @param  bool  $all
     * @return $this
     */
     ...
     * @return mixed
     *
     * @throws \LARAVEL\DatabaseCore\RecordsNotFoundException
     * @throws \LARAVEL\DatabaseCore\MultipleRecordsFoundException
     */
     ...
     *
     * @return \LARAVEL\DatabaseCore\ConnectionInterface
     */
     ...
     *
     * @return \LARAVEL\DatabaseCore\Query\Processors\Processor
     */
     ...
     *
     * @return \LARAVEL\DatabaseCore\Query\Grammars\Grammar
     */
