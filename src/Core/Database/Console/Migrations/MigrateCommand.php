<?php
namespace LARAVEL\DatabaseCore\Console\Migrations;

use Illuminate\Console\ConfirmableTrait;
use Illuminate\Contracts\Console\Isolatable;
use Illuminate\Contracts\Events\Dispatcher;
use LARAVEL\DatabaseCore\Events\SchemaLoaded;
use LARAVEL\DatabaseCore\Migrations\Migrator;
use LARAVEL\DatabaseCore\SQLiteDatabaseDoesNotExistException;
...
class MigrateCommand extends BaseCommand implements Isolatable
{
     ...
     *
     * @var \LARAVEL\DatabaseCore\Migrations\Migrator
     */
    protected $migrator;
     ...
     *
     * @param  \LARAVEL\DatabaseCore\Migrations\Migrator  $migrator
