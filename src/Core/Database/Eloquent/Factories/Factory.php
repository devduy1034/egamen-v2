...
use LARAVEL\DatabaseCore\Eloquent\Collection as EloquentCollection;
use LARAVEL\DatabaseCore\Eloquent\Model;
use LARAVEL\DatabaseCore\Eloquent\SoftDeletes;
...
/**
 * @template TModel of \LARAVEL\DatabaseCore\Eloquent\Model
 *
 * @method $this trashed()
 */
abstract class Factory
{
     ...
     *
     * @var class-string<\LARAVEL\DatabaseCore\Eloquent\Model|TModel>
     */
    protected $model;
     ...
     *
     * @param  (callable(array<string, mixed>): array<string, mixed>)|array<string, mixed>  $attributes
     * @param  \LARAVEL\DatabaseCore\Eloquent\Model|null  $parent
     ...
     *
     * @param  (callable(array<string, mixed>): array<string, mixed>)|array<string, mixed>  $attributes
     * @return \LARAVEL\DatabaseCore\Eloquent\Model|TModel
     */
     ...
     * @return \LARAVEL\DatabaseCore\Eloquent\Collection<int, \LARAVEL\DatabaseCore\Eloquent\Model|TModel>
     */
     ...
     * @param  (callable(array<string, mixed>): array<string, mixed>)|array<string, mixed>  $attributes
     * @param  \LARAVEL\DatabaseCore\Eloquent\Model|null  $parent
     * @return \LARAVEL\DatabaseCore\Eloquent\Collection<int, \LARAVEL\DatabaseCore\Eloquent\Model|TModel>|\LARAVEL\DatabaseCore\Eloquent\Model|TModel
     */
     ...
     * @param  \LARAVEL\DatabaseCore\Eloquent\Model|null  $parent
     * @return \Closure(): (\LARAVEL\DatabaseCore\Eloquent\Collection<int, \LARAVEL\DatabaseCore\Eloquent\Model|TModel>|\LARAVEL\DatabaseCore\Eloquent\Model|TModel)
     */
     ...
     *
     * @param  \LARAVEL\DatabaseCore\Eloquent\Model|null  $parent
     * @return \LARAVEL\DatabaseCore\Eloquent\Model
     */
     ...
     *
     * @param  (callable(array<string, mixed>, \LARAVEL\DatabaseCore\Eloquent\Model|null): array<string, mixed>)|array<string, mixed>  $state
     * @return static
     */
     ...
     *
     * @param  \LARAVEL\DatabaseCore\Eloquent\Factories\Factory|\LARAVEL\DatabaseCore\Eloquent\Model  $factory
     * @param  string|null  $relationship
     * @return static
     */
     ...
     *
     * @param  \LARAVEL\DatabaseCore\Eloquent\Model|\Illuminate\Support\Collection|array  $model
     * @return static
     */
     ...
     * @return \LARAVEL\DatabaseCore\Eloquent\Model|null
     */
     ...
     *
     * @param  \Closure(\LARAVEL\DatabaseCore\Eloquent\Model|TModel): mixed  $callback
     * @return static
     */
     ...
     *
     * @return class-string<\LARAVEL\DatabaseCore\Eloquent\Model|TModel>
     */
     ...
     *
     * @param  callable(self): class-string<\LARAVEL\DatabaseCore\Eloquent\Model|TModel>  $callback
     * @return void
     */
     ...
     *
     * @param  class-string<\LARAVEL\DatabaseCore\Eloquent\Model>  $modelName
     * @return \LARAVEL\DatabaseCore\Eloquent\Factories\Factory
     */
     ...
     *
     * @param  callable(class-string<\LARAVEL\DatabaseCore\Eloquent\Model>): class-string<\LARAVEL\DatabaseCore\Eloquent\Factories\Factory>  $callback
     * @return void
     */
     ...
     *
     * @param  class-string<\LARAVEL\DatabaseCore\Eloquent\Model>  $modelName
     * @return class-string<\LARAVEL\DatabaseCore\Eloquent\Factories\Factory>
     */
