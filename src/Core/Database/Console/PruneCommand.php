<?php
namespace LARAVEL\DatabaseCore\Console;

use Illuminate\Console\Command;
use Illuminate\Contracts\Events\Dispatcher;
use LARAVEL\DatabaseCore\Eloquent\MassPrunable;
use LARAVEL\DatabaseCore\Eloquent\Prunable;
use LARAVEL\DatabaseCore\Eloquent\SoftDeletes;
use LARAVEL\DatabaseCore\Events\ModelPruningFinished;
use LARAVEL\DatabaseCore\Events\ModelPruningStarting;
use LARAVEL\DatabaseCore\Events\ModelsPruned;
