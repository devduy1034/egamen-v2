...
use LARAVEL\Core\Support\Response\Response;
...
trait JsonResponse
{
    ...
    {
        return baseResponse()->json($data, $statusCode, $headers);
    }
     ...
     * @return Response
     */
    protected function respondError(string|array $message = 'Bad request', int $statusCode = 400): Response
    {
        return $this->respond([
            'success' => false,
            'errors' => [
