...
trait InteractsWithPivotRecords
{
     ...
     *
     * @param int|array<int|string, array<string, mixed>>|string|\LARAVEL\DatabaseCore\Eloquent\Collection<int, TRelatedModel>|TRelatedModel|\Illuminate\Support\Collection<int, int|string> $ids
     ...
     *
     * @param int|string|\LARAVEL\DatabaseCore\Eloquent\Collection<int, TRelatedModel>|TRelatedModel|\Illuminate\Support\Collection<int, int|string> $ids
     * @return TDeclaringModel
     */
     ...
     *
     * @param int|array<int|string, array<string, mixed>>|string|\LARAVEL\DatabaseCore\Eloquent\Collection<int, TRelatedModel>|TRelatedModel|\Illuminate\Support\Collection<int, int|string> $value
