...
use LARAVEL\DatabaseCore\Relations\Relations\Traits\CompositeKeys\SupportsBelongsToJsonCompositeKeys;
use LARAVEL\DatabaseCore\Relations\Relations\Traits\Concatenation\IsConcatenableBelongsToJsonRelation;
use LARAVEL\DatabaseCore\Relations\Relations\Traits\IsJsonRelation;
...
{
    /** @use \LARAVEL\DatabaseCore\Relations\Relations\InteractsWithPivotRecords<TRelatedModel, TDeclaringModel> */
    use InteractsWithPivotRecords;
    /** @use \LARAVEL\DatabaseCore\Relations\Relations\Traits\Concatenation\IsConcatenableBelongsToJsonRelation<TRelatedModel, TDeclaringModel> */
    use IsConcatenableBelongsToJsonRelation;
    /** @use \LARAVEL\DatabaseCore\Relations\Relations\Traits\IsJsonRelation<TRelatedModel, TDeclaringModel> */
    use IsJsonRelation;
    /** @use \LARAVEL\DatabaseCore\Relations\Relations\Traits\CompositeKeys\SupportsBelongsToJsonCompositeKeys<TRelatedModel, TDeclaringModel> */
     ...
     *
     * @param \LARAVEL\DatabaseCore\Eloquent\Collection<int, TRelatedModel> $results
