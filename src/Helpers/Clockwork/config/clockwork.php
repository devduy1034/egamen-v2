...
return [
	...
	*/
	...
	'storage_files_path' => env('CLOCKWORK_STORAGE_FILES_PATH', cache_path('clockwork')),

	// Compress the metadata files using gzip, trading a little bit of performance for lower disk usage
	'storage_files_compress' => env('CLOCKWORK_STORAGE_FILES_COMPRESS', false),

	// SQL database to use, can be a name of database configured in database.php or a path to a SQLite file
	'storage_sql_database' => env('CLOCKWORK_STORAGE_SQL_DATABASE', cache_path('clockwork.sqlite')),
	...
	*/
	...
	'stack_traces' => [
		...
		'skip_namespaces' => [
			'Pecee\SimpleRouter',
			'LARAVEL\DatabaseCore',
			'LARAVEL\Helpers',
			'LARAVEL\Core\View',
			'LARAVEL\Core\Routing',
			'Illuminate\Events',
			'Clockwork',
		],
		...
		'skip_classes' => [
			// App\CustomLog::class
			// 'LARAVEL\Core\View\View',
			// 'LARAVEL\DatabaseCore\Query\Builder',
			// 'LARAVEL\DatabaseCore\Eloquent\Builder',
			// 'LARAVEL\DatabaseCore\Eloquent\Relations\Relation',
			// 'LARAVEL\DatabaseCore\Connection',
			// 'LARAVEL\Helpers\Clockwork\Datasource\EloquentDataSource',
			// 'LARAVEL\Core\App',
			// 'LARAVEL\Core\Routing\ClassLoaderCustom',
		]
	...
	*/
	...
	'serialization_depth' => env('CLOCKWORK_SERIALIZATION_DEPTH', 20),

	// A list of classes that will never be serialized (e.g. a common service container class)
	'serialization_blackbox' => [
		\Illuminate\Container\Container::class,
		\LARAVEL\Core\Container::class,
		\LARAVEL\Core\Routing\LARAVELRouter::class,
		\LARAVEL\Core\App::class,
	],
