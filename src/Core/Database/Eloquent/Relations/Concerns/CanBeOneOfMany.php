<?php
namespace LARAVEL\DatabaseCore\Eloquent\Relations\Concerns;

use Closure;
use LARAVEL\DatabaseCore\Eloquent\Builder;
use LARAVEL\DatabaseCore\Query\JoinClause;
...
trait CanBeOneOfMany
{
     ...
     *
     * @var \LARAVEL\DatabaseCore\Eloquent\Builder|null
     */
     ...
     *
     * @param  \LARAVEL\DatabaseCore\Query\JoinClause  $join
     * @return void
     */
     ...
     *
     * @param  \LARAVEL\DatabaseCore\Eloquent\Builder  $parent
     * @param  \LARAVEL\DatabaseCore\Eloquent\Builder  $subQuery
     ...
     *
     * @return \LARAVEL\DatabaseCore\Eloquent\Builder|void
     */
