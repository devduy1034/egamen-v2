...
use LARAVEL\DatabaseCore\Relations\Relations\Traits\Concatenation\IsConcatenableHasManyJsonRelation;
use LARAVEL\DatabaseCore\Relations\Relations\Traits\CompositeKeys\SupportsHasManyJsonCompositeKeys;
 ...
 *
 * @extends \LARAVEL\DatabaseCore\Eloquent\Relations\HasMany<TRelatedModel, TDeclaringModel>
 */
class HasManyJson extends HasMany implements ConcatenableRelation
{
    /** @use \LARAVEL\DatabaseCore\Relations\Relations\Traits\Concatenation\IsConcatenableHasManyJsonRelation<TRelatedModel, TDeclaringModel> */
    ...
    use IsJsonRelation;
    /** @use \LARAVEL\DatabaseCore\Relations\Relations\Traits\CompositeKeys\SupportsHasManyJsonCompositeKeys<TRelatedModel, TDeclaringModel> */
    ...
    protected function setForeignAttributesForCreate(Model $model)
    {
        ...
        if (method_exists($model, 'belongsToJson')) {
            /** @var \LARAVEL\DatabaseCore\Relations\Relations\BelongsToJson<*, *> $relation */
