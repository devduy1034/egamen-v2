...
use LARAVEL\LARAVELGateway\OnePay\Message\International\PurchaseRequest;
use LARAVEL\LARAVELGateway\OnePay\Message\International\QueryTransactionRequest;
