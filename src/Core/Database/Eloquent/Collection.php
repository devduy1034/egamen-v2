...
class Collection extends BaseCollection implements QueueableCollection
{
     ...
     *
     * @param  array<array-key, (callable(\LARAVEL\DatabaseCore\Eloquent\Builder): mixed)|string>|string  $relations
     * @return $this
     */
     ...
     *
     * @param  \LARAVEL\DatabaseCore\Eloquent\Collection  $models
     * @param  array  $path
     * @return void
     */
     ...
     * @param  array<array-key, (callable(\LARAVEL\DatabaseCore\Eloquent\Builder): mixed)|string>  $relations
     * @return $this
     */
